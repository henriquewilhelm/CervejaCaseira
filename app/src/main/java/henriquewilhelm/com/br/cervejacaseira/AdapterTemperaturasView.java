...
public class AdapterTemperaturasPersonalizado extends BaseAdapter {

    private List<Temperaturas> temperaturas;
    private Activity act;

    public AdapterTemperaturasPersonalizado(List<Temperaturas> temperaturas, Activity act) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view = LayoutInflater.from(act)
                .inflate(R.layout.adp_temperaturas, parent, false);
